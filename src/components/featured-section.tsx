        ...
        <div className="flex flex-col md:flex-row mb-12 md:mb-28">
          <div className="flex-1 text-left py-6">
            <div className="max-w-[540px]">
              ...
              <p className="text-lg mb-4">Somos una empresa de transportes locales e internacionales que se enorgullece de su compromiso y experiencia trabajando con grandes empresas en la industria alimentaria e industrial.</p>
